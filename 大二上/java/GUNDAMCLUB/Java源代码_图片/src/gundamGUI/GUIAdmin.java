...
public class GUIAdmin extends JFrame{
	...
	private Label goods;
	private Label Title;
	//Button, AddGoods, DeleteGoods, UpdateGoods, RectifyPassword, Chat, Exit, CashOut, Register
	...
	public void Initialize(int num) {
		...
		ad = gd.admin.get(num);
		name = new String(ad.getAdminName());
		GUIShop.userName = name;
	...
	public void CHAT() {
		GUIWebClient gw = new GUIWebClient(GUIAdmin.name);
		gw.init();
	}
	public void LINK() {
